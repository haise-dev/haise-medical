...
def summarize_dialogue(dialogue: str, model_name: str, max_length: int = 500, min_length: int = 50) -> str:
    """
    ...
    # Split the dialogue into chunks if it exceeds the maximum token length
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # Input dialogue text
        user_input = input("Enter a dialogue (up to 2000 words): ").strip()
        if not user_input:
