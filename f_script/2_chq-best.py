...
# Define the paths
dataset_path = "/home/gpu/Medical_app/T5_dh/medical/haise_data/chq"
...
training_args = TrainingArguments(
    output_dir="./T5_CHQ_Model",         # Output directory for model checkpoints
    evaluation_strategy="steps",         # Evaluate every `eval_steps`
    eval_steps=50,
    save_steps=200,                     # Save checkpoints after every 62 steps
    logging_steps=10,                    # Log metrics every 50 steps
    ...
    learning_rate=2e-5,                  # Learning rate optimized for T5-base
    ...
    warmup_steps=15,                    # Added warm-up steps
)
...
result_dataset = tokenized_datasets["validate"]
print("First example from validate.jsonl (processed):", result_dataset[0])
